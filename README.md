...
6. Go to your **Documents**, to do a first try of the app:  
...
9. Last Step, go to `System Preferences` > `Security & Privacy` > `Accessibility` and allow `Script Editor.app` and `FinderNewFile.app`.  
<p align="center"><img width="400" src="https://user-images.githubusercontent.com/17025808/154738214-f6c62047-a718-41f4-ae4f-bbc4f01a193a.png">
</p>
